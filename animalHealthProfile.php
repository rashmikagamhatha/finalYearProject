...
?>
    ...
    <body class="backgroundImg6 container-fluid">
        ...
        <div class="adminBody mb-5">
            <div class="row container bg-dark-subtle rounded signup_box">
                <div class=" col-8 offset-2">
                    <h2 class="text-center mt-3">Animal Health Profile</h2>
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="form-label">Animal Id:</label>
                            <input type="text" class="form-control text-danger fw-bold" value="<?php echo $a["animal_an_id"] ?>" disabled>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="form-control" id="vdetails" rows="3"><?php echo $a["vaccination_details"] ?></textarea>
                    </div>
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <textarea class="form-control" id="tdetails" rows="3"><?php echo $a["treatment_details"] ?></textarea>
                    </div>
