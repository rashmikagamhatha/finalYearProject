            ...
            <form class="d-flex me-2">
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light">
                        ...
                        <li><a class="dropdown-item text-danger" href="#" id="a_us">about us</a></li>
                    </ul>
                </div>
                ...
                <div class="col-12 offset-1 ms-5 ms-md-0  offset-lg-0 col-md-12">
                    <div class="row">
                        <div class="justify-content-start offset-md-0 ms-5 me-5" style="width: 340px;">
                            <h4 class="text-center fw-bold " id="chartname1">Distribution of Animal Population by Type
                            </h4>
                    ...
                    <div class="row">
                        <div class="card bg-primary-subtle" style="width: 25rem;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-1 text-body-secondary mt-1">July 29: sheep fed with grain
                                    mix</h6>
