...
?>
    ...
    <body class="backgroundImg7" onload="loadUser();">
      ...
      <div class="container-fluid">
        ...
        <div class=" row d-flex justify-content-center ">
          ...
          <div class="col-12 mt-2 mb-3">
            <a class="text-decoration-none link-light fs-3 fw-bold">Employee Details</a>
            &nbsp;&nbsp;
            <a class="text-decoration-none link-light fs-6">All Employees &nbsp;&rarr;</a>
          </div>
          <!-- category name end-->
          <div class="col-8">
          ...
          <div class="row d-flex justify-content-end mt-4 mb-4">
            ...
            <i class="col-1 me-2 btn btn-outline-light bi bi-pencil-square fw-bold" onclick="updateUserStatus();"> Status</i>
            <!-- <button class="btn btn-outline-secondary col-1 " onclick="deleteUser();">Delete User</button>
              -->
              <i class="col-1 me-2 btn btn-danger bi bi-trash fw-bold" onclick="deleteUser();"></i>
          </div>

          <div class="col-4 col-md-8 mb-3" id="printAr">
            <h2 class="text-center mb-2 text-light fw-bold">Employee Report</h2>
            <br>
            <div class="row">
              <table class="table">
                <thead>
