    ...
    <div class="container-fluid">
        ...
        <div class=" row d-flex justify-content-center ">
            ...
            <div class="col-12 mt-2 mb-3">
                <a class="text-decoration-none link-light fs-3 fw-bold">Employee Management</a>
                &nbsp;&nbsp;
            ...
            <div class="row d-flex justify-content-end mt-4 mb-4">
                ...
                <i class="col-1 me-2 btn btn-outline-light bi bi-pencil-square fw-bold" onclick="updateUserStatus();">
                    Status</i>
            ...
            <div class="col-4 col-md-8 mb-3" id="printAr">
                <h2 class="text-center mb-2 text-light fw-bold">Employee Details</h2>
                <br>
                <div class="row">
                    <table class="table">
                        <thead>
