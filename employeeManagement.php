    ...
    <div class="container-fluid">
        ...
        <div class=" row d-flex justify-content-center ">
            ...
            <div class="col-12 mt-2 mb-3">
                <a class="text-decoration-none link-dark fs-3 fw-bold">Employees</a>
                &nbsp;&nbsp;
            ...
            <div class="row d-flex justify-content-end mt-4 mb-4">
                ...
                <i class="col-1 me-2 btn btn-outline-danger bi bi-pencil-square fw-bold" onclick="updateUserStatus();">
                    Status</i>
            ...
            <div class="col-4 col-md-8 mb-3" id="printAr">
                <h2 class="text-center mb-2 fw-bold">Employee Details</h2>
                <br>
                <div class="row">
                    <table class="table">
                        <thead>
