...
?>
        ...
        <body class="backgroundImg" onload="loadfood();">
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 mt-2 mb-3">
                        <a class="text-decoration-none link-dark fs-3 fw-bold">Foodstock Details List</a>
                        &nbsp;&nbsp;
                    </div>
                    <!-- category name end-->
                    ...
                    <div class="col-4 col-md-8 mb-3" id="printAr">
                        <h2 class="text-center mb-2 fw-bold">Foods Report</h2>
                        <br>
                        <div class="row">
                            <table class="table signup_box">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bg-dark-subtle">Supplier Mobile</th>
                                    </tr>
                                </thead>
                                <tbody id="tbf">
                                    <!-- Table Row  -->
