...
<body>
    ...
    <footer class="container-fluid footerBody text-white pb-5 pt-4 ">
            ...
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-8 mx-auto mt-3">
                    ...
                    <p id="ftrnote">"LezaFarming is an innovative Livestock Management System tailored for small to medium-scale farms in Sri Lanka, 
                        ...
                        automated alerts for vaccinations and treatments, breeding records, and feeding management. LezaFarming is designed with user accessibility in mind, 
                        ensuring ease of use for all farmers, regardless of their technical expertise. By automating key processes, it helps farmers boost efficiency, 
                        reduce errors, and improve overall livestock productivity, contributing to modern, sustainable farming practices in Sri Lanka."</p>
