    ...
    <div class="container-fluid">
      ...
      <form class="d-flex me-2">
        ...
        <div class="text-center me-3 mt-1 ">
          <span class="text-lg-start text-success fw-bolder">User</span>
        </div>
        ...
        <div class="dropdown me-3">
          ...
          <ul class="dropdown-menu dropdown-menu-light">
            ...
            <li><a class="dropdown-item text-danger" href="#">Admin Login</a></li>
          </ul>
        </div>
    ...
    <div class="offcanvas-body">
      ...
      <ul class="navbar-nav ">
        ...
        <li>
          ...
          <span class="btn btn-outline-secondary col-11">Personal LiveStock details and Health Status</span>
        </li>
        <li>
          <a href="#" class="nav-link active"></a>
          <span class="btn btn-outline-secondary col-11">Records and Track health checks</span>
        </li>
        <li>
          <a href="#" class="nav-link active"></a>
          <span class="btn btn-outline-secondary col-11">Treatments</span>
        </li>
        <li>
          <a href="#" class="nav-link active"></a>
