...
?>
        ...
        <body class="backgroundImg4" onload="loadstocks();">
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 mt-2 mb-3">
                        <a class="text-decoration-none link-light fs-3 fw-bold">Product Management & Reports</a>
                        &nbsp;&nbsp;
                    </div>
                    <!-- category name end-->

                    <div class="row d-flex justify-content-center mt-4 mb-4">
                        <a class="btn btn-outline-light fw-bold col-8 mb-3 " href="manageProduct.php">Product Management</a>
                        <a class="btn btn-outline-light fw-bold col-8 mb-3" href="manure.php">Manure Management</a>
                    </div>
                    ...
                    <div class="row d-flex justify-content-end mt-4 mb-4 me-5">
                        ...
                        <i class="col-1 me-2 btn btn-danger bi bi-trash fw-bold" onclick="removestock();"></i>
                    </div>
                    ...
                    <div class="col-4 col-md-8 mb-3" id="printAr">
                        <h2 class="text-center text-light mb-2 fw-bold">Production Reports</h2>
                        <br>
                        <div class="row">
                    ...
                    <div class="row d-flex justify-content-end mt-4 mb-4 me-5">
                        ...
                        <i class="col-1 me-2 btn btn-danger bi bi-trash fw-bold" onclick="removebystock();"></i>
                    </div>
                    ...
                    <div class="col-4 col-md-8 mb-3" id="printAr2">
                        <h2 class="text-center text-light mb-2 fw-bold">By-Product Report</h2>
                        <br>
                        <div class="row">
                            <table class="table signup_box">
                                <thead>
